        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-3 text-4xl md:text-5xl font-semibold tracking-tight">
              Proven on high-density{" "}
              <span className="text-gradient-accent">AI workload simulations.</span>
            </h2>
            <p className="mt-4 text-muted-foreground">
              Response time: up to 1 second BEFORE the spike. Solving a 1 MW power spike at a
              fraction of the cost of lithium-ion alternatives.
            </p>
          </div>
          ...
          >
            <p className="text-xs font-mono uppercase tracking-widest text-muted-foreground">
              Solving a 1 MW Power Spike — Total 20-Year Cost
            </p>
            <div className="mt-6 grid md:grid-cols-2 gap-6">
              <div className="glass lift rounded-2xl p-6">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  High-Rate Lithium-Ion · 6 cabinets · 9 tons
                </p>
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  4 full replacements over 20 years
                </p>
              </div>
          ...
          <div className="mt-10 grid md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
                Patent covers prevention of extreme electrical load spikes — including those caused
                by synchronized GPU workloads in AI data centers.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              ...
              <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
                Time-series data prediction with deep learning. All technology, code and IP are
                fully owned by PrePeak.
              </p>
            </motion.div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            >
              ...
              <p className="mt-5 text-muted-foreground leading-relaxed">
                We start with high-pain operators and expand to integrators (Schneider, Vertiv, ABB)
                and hyperscalers after validation.
              </p>
                ...
                {customers.map((c) => (
                  ...
                  >
                    ...
                    <ul className="mt-3 space-y-1.5">
                      {c.names.map((n) => (
                        <li key={n} className="text-sm text-foreground/85">
                          {n}
                        </li>
                      ))}
                    </ul>
