...
const impacts = [
  {
    ...
    features: [
      ...
      "Damage to GPUs and critical equipment",
      "System instability",
    ],
  },
  {
    ...
    features: [
      "$500K+ per downtime event",
      "Up to 30% stranded power capacity",
      "$1.5M infrastructure cost per 1 MW",
      "$300K/year in unused GPUs per 1 MW",
    ],
  },
  {
    icon: Cpu,
            ...
            >
              <TiltCard className="h-full rounded-2xl">
                <div className="group relative h-full glass lift-shine rounded-2xl p-8 hover:border-primary/50">
                  <div
                    className="absolute -top-20 -right-20 h-40 w-40 rounded-full bg-primary/15 blur-3xl opacity-0 group-hover:opacity-100 transition-opacity"
                    aria-hidden
                  />
